...
public class crack {
    ...
    public String crack_api(String pwd, String code, @RequestParam(value = "uid", required = false) String uid, String pid, String v, String v2, String v3) throws UnsupportedEncodingException {
